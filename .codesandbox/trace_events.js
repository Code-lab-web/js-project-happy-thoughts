...
const { ArrayPrototypeJoin, SafeSet } = primordials;

const { hasTracing } = internalBinding("config");

const kMaxTracingCount = 10;

const { ERR_TRACE_EVENTS_CATEGORY_REQUIRED, ERR_TRACE_EVENTS_UNAVAILABLE } =
...
const { validateObject, validateStringArray } = require("internal/validators");
