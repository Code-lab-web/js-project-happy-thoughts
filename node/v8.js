...
const { namespace: startupSnapshot } = require("internal/v8/startup_snapshot");
...
const { createHeapSnapshotStream, triggerHeapSnapshot } =
...
function setHeapSnapshotNearHeapLimit(limit) {
  ...
  if (
    heapSnapshotNearHeapLimitCallbackAdded ||
