...
if (getOptionValue("--tls-min-v1.0")) exports.DEFAULT_MIN_VERSION = "TLSv1";
...
else exports.DEFAULT_MIN_VERSION = "TLSv1.2";

if (getOptionValue("--tls-max-v1.3")) exports.DEFAULT_MAX_VERSION = "TLSv1.3";
else if (getOptionValue("--tls-max-v1.2"))
  exports.DEFAULT_MAX_VERSION = "TLSv1.2";
else exports.DEFAULT_MAX_VERSION = "TLSv1.3"; // Will depend on node version.
...
exports.checkServerIdentity = function checkServerIdentity(hostname, cert) {
  ...
  if (net.isIP(hostname)) {
    ...
    if (dnsNames.length > 0) {
      ...
      if (ArrayIsArray(cn)) valid = cn.some(wildcard);
